...
# Use cmd.exe to run gradlew.bat and merge stderr (2>&1) before PowerShell sees it.
# This prevents PowerShell from converting stderr warnings into terminating NativeCommandErrors.
cmd.exe /c """$PSScriptRoot\gradlew.bat"" runClient 2>&1" | Tee-Object -FilePath $logFile
